...
export default function ComandaNotFound() {
  return (
    <div className="flex min-h-[50vh] flex-col items-center justify-center gap-3 rounded-lg border border-[#262B25] bg-[#171B18] p-8 text-center">
      ...
      <p className="text-sm text-[#8B948C]">Esta mesa não foi encontrada.</p>
      <Link href="/comanda" className="text-sm text-[#E8791A] hover:underline">
